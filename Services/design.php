...
<div class="w3-main" style="margin-left:250px">
    ...
    <!-- Top header -->
      ...
      <div class="container" align="left" style="margin:20px 50px">
           ...
           <h4><b>Design for 3D printing </b></h4>
           </div>
      </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" align="left" style="margin:50px">
    ...
    <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
      ...
      <div class="container" align="left" style="margin:0px 50px">
           <div class="row">
           <p>Design for 3d printing is a designing process through which the part can be design according to its final use or purpose but can be optimized for easy 3d printing for reducing the chance of any errors or defects occurrence during the 3d printing process or after production of final part.</br></br>
