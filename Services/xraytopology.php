<!DOCTYPE html>
<html>
<title>IPRO3D-XRayTopology</title>
<meta charset="UTF-8">
...
<div class="container">
    <div class="row">
        <h2 style="text-align: center;"><b>X-Ray Topology</b></h2>
        <br>
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                    <img src="../temp-img/xray1.jpg" alt="Image" style="height: 373px ;width: 1024px">
                ...
                <div class="item">
                    <img src="../temp-img/xray2.jpg" alt="Image" style="height: 373px ;width: 1024px">
                    <div class="carousel-caption">
                        <!--<h1>MAHARASHTRA VOCATIONAL TRAINING CENTER</h1>
                        <p> Affiliated to Maharashtra State Board of Vocational Education Examination, Mumbai </p>
                        <h3>Institute Code: 170523</h3> -->
