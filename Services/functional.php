...
<div class="w3-main" style="margin-left:250px">
    ...
    <!-- Top header -->
      ...
      <div class="container" align="left" style="margin:20px 50px">
           ...
           <h4><b>Functional part manufacturing</b></h4>
           </div>
      </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" align="left" style="margin:50px">
    ...
    <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
      ...
      <div class="container" align="left" style="margin:0px 50px">
           <div class="row">
           <p>Additive manufacturing (3d printing) showing a lot of promise is in integrated assemblies. It helps reduce the 3d print time of your object simply by integrating an assembly plan into your 3D model before actually 3d printing it. This will reduce the items you need to manufacture and save you time in the 3d printing process.
