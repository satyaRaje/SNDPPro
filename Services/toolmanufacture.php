...
<div class="w3-main" style="margin-left:250px">
    ...
    <!-- Top header -->
      ...
      <div class="container" align="left" style="margin:20px 50px">
           ...
           <h4><b>Tooling Manufacturing:</b></h4>
           </div>
      </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" align="left" style="margin:50px">
    ...
    <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
      ...
      <div class="container" align="left" style="margin:0px 50px">
           <div class="row">
           <p>Tooling is also known as machine tooling. It is the manufacturing of components, tools and machines needed for production. The common categories of machine tooling include fixture, jigs, gauges, moulds, dies, cutting equipment, patterns, etc.
