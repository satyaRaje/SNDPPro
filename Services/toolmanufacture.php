        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                    <img src="../temp-img/img22.jpg" alt="Image" style="height: 373px ;width: 1024px">
                ...
                <div class="item">
                    <img src="../temp-img/img23.jpg" alt="Image" style="height: 373px ;width: 1024px">
                    <div class="carousel-caption">
                        <!--<h1>MAHARASHTRA VOCATIONAL TRAINING CENTER</h1>
                        <p> Affiliated to Maharashtra State Board of Vocational Education Examination, Mumbai </p>
                        <h3>Institute Code: 170523</h3> -->
...
<div class="container" style="padding: 20px;">
    <div class="row">
        ...
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tooling is also known as machine tooling. It is the manufacturing of components, tools and machines needed for production. The common categories of machine tooling include fixture, jigs, gauges, moulds, dies, cutting equipment, patterns, etc.</p></br> </br>
    </div>
</div>
