...
<div class="w3-main" style="margin-left:250px">
    ...
    <!-- Top header -->
      ...
      <div class="container" align="left" style="margin:20px 50px">
           ...
           <h4><b>Small Batch Manufacturing:</b></h4>
           </div>
      </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" align="left" style="margin:50px">
    ...
    <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
      ...
      <div class="container" align="left" style="margin:0px 50px">
           <div class="row">
           <p>Small batch production can be done using 3d printing technology for directly producing end use parts. SLS (Selective laser sintering), DMLS (Direct Metal Laser Sintering), SLA (Stereolithography), etc. machines are ideally suited to producing low volume plastic and metal parts, from one to as many as thousands. 3D printing produces parts in engineering grade and biocompatible materials which provides both strong and accurate parts as well as affordable which makes it a perfect application for your batch production needs.
