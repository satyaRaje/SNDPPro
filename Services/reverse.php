...
<div id="myCarousel" class="carousel slide" data-ride="carousel" align="left" style="margin:50px">
    ...
    <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
      ...
      <div class="container" align="left" style="margin:0px 50px">
           <div class="row">
           <p>Reverse engineering is a method used to understand an item and its interaction with various components. It is helpful when you want to create an exact copy or customize according to your needs of a common product with a 3D printer.</br></br>
