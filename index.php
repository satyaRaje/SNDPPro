    ...
    <div class="container-fluid text-center">
        <div class="row" style="color:white;background-color: lightgray;">
            ...
            <div class="row">
                    ...
                    <div class="col-sm-2">
                        <img src="img/ourwork/bottle.JPG" height="200px" width="200px" class="img img-rounded">
                    </div>
                    <div class="col-sm-2">
                        <img src="img/ourwork/am1.jpg" height="200px" width="200px" class="img img-rounded">
                    </div>
                    <div class="col-sm-2">
                        <img src="img/ourwork/am2.jpg" height="200px" width="200px" class="img img-rounded">
                    </div>
                    <div class="col-sm-2">
                        <img src="img/ourwork/motor2.jpg" height="200px" width="200px" class="img img-rounded">
                    </div>
                <div class="col-sm-2">
                    <img src="img/ourwork/sla.jpg" height="200px" width="200px" class="img img-rounded">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <img src="img/ourwork/tower.jpg" height="200px" width="200px" class="img img-rounded">
                    </div>
                    <div class="col-sm-2">
                        <img src="img/ourwork/gyro.jpg" height="200px" width="200px" class="img img-rounded">
                    </div>
